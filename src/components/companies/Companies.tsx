...
const Companies = () => {
  return (
    <section className="bg-[--blue0] sm:min-h-[900px] text-white text-center flex flex-col justify-between pt-[100px]">
      ...
      <p className="self-center text-parag-md lg:text-parag-lg my-10 w-[80%] md:w-[70%] max-w-[900px] opacity-80">
        ...
        éxito. En cada envío, no solo entregamos mercancías y paquetería, sino también
